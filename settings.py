...
RL_ACTIVATION_MODEL_PATH = "./rl_activation_model.json"
RL_ACTIVATION_LEARNING_RATE = 0.01
RL_ACTIVATION_DISCOUNT_FACTOR = 0.95
RL_ACTIVATION_EPSILON = 0.1
RL_ACTIVATION_MIN_EPSILON = 0.01
RL_ACTIVATION_EPSILON_DECAY = 0.999
RL_ACTIVATION_REWARD_ENERGY_WEIGHT = 0.05
RL_ACTIVATION_REWARD_REJECTION_WEIGHT = 10.0
RL_ACTIVATION_REWARD_QOS_WEIGHT = 10.0
RL_ACTIVATION_REWARD_DELAY_WEIGHT = 2.0
RL_ACTIVATION_REWARD_SWITCH_WEIGHT = 0.1
RL_ACTIVATION_MIN_ACTIVE_SERVERS = 1
RL_ACTIVATION_BOOT_TIME_REFERENCE = 300.0
RL_ACTIVATION_AUTOSAVE_DECISIONS = 25
RL_ACTIVATION_SEED = None
